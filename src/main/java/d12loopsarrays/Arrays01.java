...
public class Arrays01 {
    ...
    3)Array olusturmak icin
        i)Data Tipi
        ii)Data sayisi (Dizi boyutu için belirtilebilecek maksimum değer, Integer.MAX_VALUE (yaklaşık 2 milyar) olarak sınırlıdır) soylenmelidir.
...
*/
        ...
        String[] stdNames1 = new String[3]; //tercih edilen. data sayisini yazmazsak hata verir
...
;
        ...
        //Array'e eleman eklemek (index mantigiyla ekleniyor)
