...
public class Car {
     /* - Bir veri yapısı veya yardımcı bir class oluştururken, genellikle
            main methoduna ihtiyaç duymazsınız.
            - Ancak bir uygulama geliştirirken veya bağımsız bir program çalıştırırken,
            main methodu oluşturmanız gerekebilir.
            - Gercek projelerde genelde bircok class olur ve sadece 1 tane main method'lu class olur.
    ...
    //11- ikitane daha custom constructor olusturalim
