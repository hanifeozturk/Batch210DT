...
public abstract class Honda {
   ...
   7) Final methodlar, classlar override edilemedigi icin, abstract olamazlar.
      (***“final” bir access modifier değildir. “final,” bir Java anahtar kelimesidir)

   8) Abstract bir class’in abstract bir child’i olabilir
    ve abstract child parent’inin methodlarini override etmek zorunda degildir ama isterse de edebilir
