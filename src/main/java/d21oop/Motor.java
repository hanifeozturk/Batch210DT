...
public interface Motor {
    ...
    int fiyat = 2000; //public static final int fiyat = 2000; asli bu

    int fiyat2 = 300;

    //{} parantez ile concret -somut- method olusturalim

    default void guc(){ //default access modifier degildir, keyworddur.
        System.out.println("200HP");
    }
    static void hiz (){
        System.out.println("Saaatte 250km");
    }
