...
public class LinkedList01 {
    public static void main(String[] args) {
       ...
       // List<String> list3 = new List(); //HATA - constructor tarafina interface(list) yazamazsin, object uretmez

        //ArrayList====>[A,L,I,C,A,N]
        //               0 1 2 3 4 5
        ...
        boolean m1 = myList.remove("Hanife");
        System.out.println(m1); //false: bulamadim silemedim
        boolean m2 = myList.remove("Ali"); // ali yazilirsa bulamaz; kucuk buyuk harfe duyarli.
        System.out.println(m2); //true : buldum sildim
