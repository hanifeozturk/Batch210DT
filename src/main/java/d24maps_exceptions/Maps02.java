...
public class Maps02 {
    public static void main(String[] args) {
        ...
        System.out.println(stdAges); //{Can=19, Ahmet=41, Tom=39, Veli=63, Ali=18}
        //degisiklik olmadi cunku eski deger 21 degil.

        stdAges.replace("Tom", 39, 45);
        System.out.println(stdAges); //{Can=19, Ahmet=41, Tom=45, Veli=63, Ali=18} degisiklik oldu
        ...
        System.out.println(stdAges.getOrDefault("Tom", -1)); //45, Tom map'te var.

        System.out.println(stdAges.get("Jerry")); //null
        System.out.println(stdAges.getOrDefault("Jerry", -1)); //Jerry map'te yok.default value'yu verdi
