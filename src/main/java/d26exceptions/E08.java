...
public class E08 { public static void main(String[] args) throws IOException {
        /*
    ...
    //Herhangi bir sebeple Java, txt dosyasina ulasamazsa diye, duzenleme yapmamizi istiyor.
    //Iste bu duruma "compile time exception" denir.
    ...
    */
    ...
    int k = 0; //dosya okuma da arka planda ascii kod kullanildigi icin bu degiskeni olusturduk
    ...
    while ((k = fis.read()) != -1){ //compile time exception, java, ya okuyamazsam diyor
        ...
        //Bu ifade de, k isimli int turundeki degiskenin degerini char
        //turune donusturuyoruz. Bu isleme "tip donusumu" ya da " type casting" denir
        //Java kolaydir
    }
