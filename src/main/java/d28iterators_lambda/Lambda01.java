...
public class Lambda01 {
    ...
    public static void printElements2(List<Integer> nums) {
        //stream() (api) metodu, koleksiyonları bir akışa (stream) dönüştürerek üzerinde işlem yapmayı sağlar.
        //Akışın (stream) adı, verinin bir kaynaktan hedefe doğru "akmasını" ifade eder.

        //12 9 131 14 9 10 4 12 15

        nums.stream().forEach(t -> System.out.print(t + " ")); //t degisken adidir. type'dan gelir.  //12 9 131 14 9 10 4 12 15
    }
