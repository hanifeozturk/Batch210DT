...
public class StringManipulations03 {
    public static void main(String[] args) {
        /*Java'da bellek (memory) yönetimi, büyük ölçüde Java Virtual Machine (JVM) tarafından otomatik
        olarak gerçekleştirilir. Java'da iki ana bellek alanı vardır: Heap (yigin) ve Stack (yigin).
        ...
        Java ve benzeri yüksek seviye diller, referansları-reference stack belleğinde
        ve asıl nesne verilerini heap belleğinde saklar.
        Bu yaklaşım, hem hızlı erişim hem de dinamik bellek yönetimi(basit-cunku heap karisik) arasında bir denge sağlar.
         */

        /*Java'da bellek (memory) yönetimi, büyük ölçüde Java Virtual Machine (JVM) tarafından
        otomatik olarak gerçekleştirilir. Java'da iki ana bellek alanı vardır: Heap (yigin) ve Stack (yigin).

        ==>Heap, dinamik olarak oluşturulan Objectler için kullanılır. Yani, new anahtar kelimesi
        ile oluşturduğunuz nesneler heap bölgesinde saklanır.
        ...
        asıl nesne verilerini heap belleğinde saklar.Bu yaklaşım, hem hızlı erişim hem de dinamik
        bellek yönetimi(basit-cunku heap karisik) arasında bir denge sağlar.
                 */
        ...
        equals() methodu ise iki String’i karsilastirirken sadece degerlerine bakar, degerleri ayni ise bu iki String esittir der, degerler farkli ise bu iki String farklidir der
        */
